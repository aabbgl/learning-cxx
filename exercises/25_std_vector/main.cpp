...
int main(int argc, char **argv) {
    {
        ...
        // sizeof(vec) 是vector对象本身的大小（通常是3个指针的大小），与元素数量无关
        ASSERT(sizeof(vec) == 24, "Fill in the correct value."); // 典型64位系统值
        int ans[]{1, 2, 3, 4, 5};
    ...
    }
    {
        ...
        {
            ASSERT(vec.size() == 5, "Fill in the correct value.");
            ASSERT(sizeof(vec) == 24, "Fill in the correct value."); // 同上
        ...
        }
        {
            ...
            ASSERT(vec.capacity() == 5, "Fill in the correct value."); // capacity可能保留
        }
    }
    {
        std::vector<char> vec(48, 'z'); // 用count和value初始化
        ...
        ASSERT(sizeof(vec) == 24, "Fill in the correct value."); // 对象大小不变
        {
            ...
            ASSERT(vec.capacity() == capacity, "Fill in a correct identifier."); // capacity可能不变
        }
        {
            vec.reserve(256);
            ASSERT(vec.size() == 16, "Fill in the correct value.");
        ...
        }
        {
            ...
            ASSERT(vec.capacity() == 256, "Fill in the correct value.");
            ASSERT(vec[15] == 'z', "Fill in the correct value."); // 原元素
